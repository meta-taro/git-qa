...
const ja = {
  ...
  'live.retry': '映像が切れました（{message}）。{seconds} 秒後に繋ぎ直します',
  'live.stalled':
  ...
  'key.zoomOut': '映像を縮小',
  'key.zoomReset': '等倍に戻す',
  'key.zoom.note': 'AI が指した所へ寄ります（証跡は変わりません）',
...
const en: Record<keyof typeof ja, string> = {
  ...
  'live.retry': 'The video stopped ({message}). Reconnecting in {seconds}s',
  'live.stalled':
  ...
  'key.zoomReset': 'Back to 1:1',
  'key.zoom.note': 'Moves to where the AI pointed (evidence is unchanged)',
